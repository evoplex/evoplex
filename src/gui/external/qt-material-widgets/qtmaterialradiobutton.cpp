...
void QtMaterialRadioButtonPrivate::init()
{
    ...
    q->setCheckedIcon(QIcon(":/icons/material/material-icons/toggle/svg/ic_radio_button_checked_24px.svg"));
    q->setUncheckedIcon(QIcon(":/icons/material/material-icons/toggle/svg/ic_radio_button_unchecked_24px.svg"));
